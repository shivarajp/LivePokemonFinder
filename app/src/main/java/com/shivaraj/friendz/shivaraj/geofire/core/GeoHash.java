...
public class GeoHash {
    ...
    public static final int MAX_PRECISION_BITS = MAX_PRECISION * com.shivaraj.friendz.shivaraj.geofire.util.Base32Utils.BITS_PER_BASE32_CHAR;
    ...
    public GeoHash(double latitude, double longitude, int precision) {
        ...
        for (int i = 0; i < precision; i++) {
            int hashValue = 0;
            for (int j = 0; j < com.shivaraj.friendz.shivaraj.geofire.util.Base32Utils.BITS_PER_BASE32_CHAR; j++) {
                boolean even = (((i* com.shivaraj.friendz.shivaraj.geofire.util.Base32Utils.BITS_PER_BASE32_CHAR) + j) % 2) == 0;
            ...
            buffer[i] = com.shivaraj.friendz.shivaraj.geofire.util.Base32Utils.valueToBase32Char(hashValue);
        }
        this.geoHash = new String(buffer);
    }

    public GeoHash(String hash) {
        if (hash.length() == 0 || !com.shivaraj.friendz.shivaraj.geofire.util.Base32Utils.isValidBase32String(hash)) {
