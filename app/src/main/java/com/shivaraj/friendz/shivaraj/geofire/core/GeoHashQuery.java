package com.shivaraj.friendz.shivaraj.geofire.core;

import com.shivaraj.friendz.shivaraj.geofire.GeoLocation;
import com.shivaraj.friendz.shivaraj.geofire.util.Base32Utils;
...
public class GeoHashQuery {
    ...
    public static class Utils {
        ...
        public static double bitsLatitude(double resolution) {
            return Math.min(Math.log(com.shivaraj.friendz.shivaraj.geofire.util.Constants.EARTH_MERIDIONAL_CIRCUMFERENCE/2/resolution)/Math.log(2),
                    GeoHash.MAX_PRECISION_BITS);
        }

        public static double bitsLongitude(double resolution, double latitude) {
            double degrees = com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.distanceToLongitudeDegrees(resolution, latitude);
        ...
        public static int bitsForBoundingBox(GeoLocation location, double size) {
            double latitudeDegreesDelta = com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.distanceToLatitudeDegrees(size);
    ...
    public static Set<GeoHashQuery> queriesAtLocation(GeoLocation location, double radius) {
        ...
        double latitudeDegrees = radius/ com.shivaraj.friendz.shivaraj.geofire.util.Constants.METERS_PER_DEGREE_LATITUDE;
        double latitudeNorth = Math.min(90, latitude + latitudeDegrees);
        double latitudeSouth = Math.max(-90, latitude - latitudeDegrees);
        double longitudeDeltaNorth = com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.distanceToLongitudeDegrees(radius, latitudeNorth);
        double longitudeDeltaSouth = com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.distanceToLongitudeDegrees(radius, latitudeSouth);
        ...
        GeoHash geoHashW = new GeoHash(latitude, com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.wrapLongitude(longitude - longitudeDelta), geoHashPrecision);
        GeoHash geoHashE = new GeoHash(latitude, com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.wrapLongitude(longitude + longitudeDelta), geoHashPrecision);

        GeoHash geoHashN = new GeoHash(latitudeNorth, longitude, geoHashPrecision);
        GeoHash geoHashNW = new GeoHash(latitudeNorth, com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.wrapLongitude(longitude - longitudeDelta), geoHashPrecision);
        GeoHash geoHashNE = new GeoHash(latitudeNorth, com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.wrapLongitude(longitude + longitudeDelta), geoHashPrecision);

        GeoHash geoHashS = new GeoHash(latitudeSouth, longitude, geoHashPrecision);
        GeoHash geoHashSW = new GeoHash(latitudeSouth, com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.wrapLongitude(longitude - longitudeDelta), geoHashPrecision);
        GeoHash geoHashSE = new GeoHash(latitudeSouth, com.shivaraj.friendz.shivaraj.geofire.util.GeoUtils.wrapLongitude(longitude + longitudeDelta), geoHashPrecision);
