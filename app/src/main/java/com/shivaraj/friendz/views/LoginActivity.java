...
import com.shivaraj.friendz.controllers.net.GoogleManager;
import com.shivaraj.friendz.controllers.net.GoogleService;
import com.shivaraj.friendz.controllers.net.NianticManager;
import com.shivaraj.friendz.models.login.GoogleLoginInfo;
import com.shivaraj.friendz.models.login.LoginInfo;
import com.shivaraj.friendz.models.login.PtcLoginInfo;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextView authenticating_tv;
...
*/
        ...
        authenticating_tv = (TextView) findViewById(R.id.authenticating_tv);
    ...
    /**
     * Just fwd to my signin activity it will hadle
     * Read there rest
     */
    ...
    private void showProgress(final boolean show) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            authenticating_tv.setVisibility(show ? View.VISIBLE : View.GONE);
